  ...
  <div id="admin" class="col-md-10 col-md-offset-1">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="?tag=home">School Managment System</a>
      </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li><a href="?tag=home">Home</a></li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="everyone.php?tag=subject_entry">View Results</a>
                    </li>
                </ul>
              </li>
              <li class="dropdown">
 ...
 -->              </li>
  ...
  <ul class="nav navbar-nav side-nav visible-lg visible-md visible-sm">
      ...
      <li>
          <a href="everyone.php?tag=subject_entry">Print Results</a>
      </li>
      <li>
          <a href="everyone.php?tag=view_scores">View Scores</a>
      </li>
        </ul>
</div>
</nav>
