...
<div class="col-md-10 col-md-offset-1 form-style">
    <div class="col-md-10 col-md-offset-1">
        <form role="form" data-toggle="validator" method="post" class="form-horizontal">
            <div class="row">
              <div style="text-align: center">  <h2>Select Class To Show Students</h2></div> <br>
                <div class="form-group">
                    <label for="smesterText" class="control-label col-sm-3">Select Class To Show:</label>
                    <div class="col-sm-8">
                       <select class="form-control" name="class_name" id="btn_select_specific_class">
                           <?php  
                ...
                <div class="form-group">
                    <input type="submit" name="btn_print" value="View Students" class="btn btn-success col-md-offset-4 col-sm-offset-4 col-xs-offset-2 btn-lg" id="btn_show_class" />
                </div>
            </div>
        </form>
    </div>
